...
const Header = () => {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 w-full h-[80px] flex items-center px-[64px] bg-black-18 z-50 transition-all duration-300",
        isScrolled ? "h-[60px] shadow-lg bg-white" : "h-[80px] bg-black-18"
      )}
    >
